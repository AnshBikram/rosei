<html>
<head>
<script src="Files/StudentCancelCoupon.js"></script>
		...
		<!-- <input id="submit" type="submit" onSubmit="window.parent.location.reload();" value="Submit">-->
			<table id="Coupon" ><!--table contains our selection for meal-->
						...
						<tr>
							...
							<td>
								<div id="mess1b3" onclick="change2(this)"><p>Roseighara-2(V)
</p></div>
								<!--<div id="mess2b3" style="left:25px;" onclick="change2(this)">Mess 2</div>-->
							</td>
							<td align="center">
								<div id="mess1l3" onclick="change2(this)"><p>Roseighara-1(N)
</p></div>
						...
						<tr>
							...
							<td>
								<div id="mess1b4" onclick="change2(this)"><p>Roseighara-1(N)
</p></div>
						...
						<tr>
							...
							<td align="center">
								<div id="mess1l5" onclick="change2(this)"><p>Roseighara-2(N)
</p></div>
						...
						<tr>
							...
							<td>
								<div id="mess1b6" onclick="change2(this)"><p>Roseighara-1(N)
</p></div>
								<!--<div id="mess2b6" style="left:25px;" onclick="change2(this)">Mess 2</div>-->
							</td>
							<td align="center">
								<div id="mess1l6" onclick="change2(this)"><p>Roseighara-1(V)
</p></div>
						...
						<tr>
							...
							<td>
								<div id="mess1b7" onclick="change2(this)"><p>Roseighara-2(V)
</p></div>
								<!--<div id="mess2b7" style="left:25px;" onclick="change2(this)">Mess 2</div>-->
							</td>
							<td align="center">
								<div id="mess1l7" onclick="change2(this)"><p>Roseighara-1(N)
</p></div>
								<!--<div id="mess2l7" style="left:25px;" onclick="change2(this)">Mess 2</div>-->
							</td>
							<td align="center">
								<div id="mess1d7" onclick="change2(this)"><p>Roseighara-2(N)
</p></div>
						...
						<tr>
							...
							<td></td>
							<td>
								<input type="submit" id="submit" value="Cancel" onclick="createArray()" />
							</td>
							<td></td>
						</tr>
					</table>
